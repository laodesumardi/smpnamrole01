    ...
    @if(isset($sections['hero']) && $sections['hero']->is_active)
        @php
            ...
            if ($sections['hero']->image) {
                ...
                $position = $sections['hero']->image_position ?? 'center';
                $heroBgStyle = "background-image: url('{$imageUrl}'); background-size: cover; background-position: {$position}; background-repeat: no-repeat;";
                $hasImage = true;
            } else {
