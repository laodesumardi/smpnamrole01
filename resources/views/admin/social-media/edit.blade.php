...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
            <div>
                <h3 class="text-lg font-medium text-gray-900">Edit Sosial Media</h3>
                <p class="text-sm text-gray-500">Perbarui informasi sosial media</p>
            </div>
        ...
        <form action="{{ route('admin.social-media.update', $social_medium) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name', $social_medium->name) }}" 
            ...
            <div>
                ...
                <input type="url" name="url" id="url" value="{{ old('url', $social_medium->url) }}" 
            ...
            <div>
                ...
                <input type="text" name="icon" id="icon" value="{{ old('icon', $social_medium->icon) }}" 
            ...
            <div>
                ...
                <div class="flex items-center space-x-4">
                    <input type="color" name="color" id="color" value="{{ old('color', $social_medium->color) }}" 
                           class="w-16 h-10 border border-gray-300 rounded-lg cursor-pointer @error('color') border-red-500 @enderror" required>
                    <input type="text" name="color_text" id="color_text" value="{{ old('color', $social_medium->color) }}" 
            ...
            <div>
                ...
                <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $social_medium->sort_order) }}" 
            ...
            <div>
                <label class="flex items-center">
                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', $social_medium->is_active) ? 'checked' : '' }} 
