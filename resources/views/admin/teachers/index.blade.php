                ...
                <div class="flex items-center">
                    <div class="p-2 sm:p-3 bg-purple-100 rounded-full">
                        <svg class="w-5 h-5 sm:w-6 sm:h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2h-4a2 2 0 00-2 2v12a2 2 0 00-2 2z"></path>
                        </svg>
                    </div>
                    <div class="ml-3 sm:ml-4">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <img src="{{ $teacher->photo_url }}" alt="{{ $teacher->name }}" 
                                             ...
                                             onerror="this.onerror=null;this.src='/images/default-teacher.png'">
                                        @if($teacher->photo)
